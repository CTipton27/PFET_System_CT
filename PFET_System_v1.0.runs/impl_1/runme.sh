...
HD_PWD='C:/Users/ychna/xilinx_vivado/PFET_System_v1.0/PFET_System_v1.0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pfet_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pfet_system_wrapper.tcl -notrace
