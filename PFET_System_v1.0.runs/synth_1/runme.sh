...
HD_PWD='C:/Users/ychna/xilinx_vivado/PFET_System_v1.0/PFET_System_v1.0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pfet_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pfet_system_wrapper.tcl
