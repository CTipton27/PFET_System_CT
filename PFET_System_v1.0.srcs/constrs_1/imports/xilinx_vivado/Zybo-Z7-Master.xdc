...
Pmod Header JA (XADC)
#set_property -dict { PACKAGE_PIN N15 } [get_ports { vauxp0_0 }]; #IO_L21P_T3_DQS_AD14P_35 Sch=JA1_R_p
#set_property -dict { PACKAGE_PIN L14 } [get_ports { vauxp1_0 }]; #IO_L22P_T3_AD7P_35 Sch=JA2_R_P
#set_property -dict { PACKAGE_PIN K16 } [get_ports { vauxp2_0 }]; #IO_L24P_T3_AD15P_35 Sch=JA3_R_P
#set_property -dict { PACKAGE_PIN K14 } [get_ports { vauxp3_0 }]; #IO_L20P_T3_AD6P_35 Sch=JA4_R_P
#set_property -dict { PACKAGE_PIN N16 } [get_ports { vauxn0_0 }]; #IO_L21N_T3_DQS_AD14N_35 Sch=JA1_R_N
#set_property -dict { PACKAGE_PIN L15 } [get_ports { vauxn1_0 }]; #IO_L22N_T3_AD7N_35 Sch=JA2_R_N
#set_property -dict { PACKAGE_PIN J16 } [get_ports { vauxn2_0 }]; #IO_L24N_T3_AD15N_35 Sch=JA3_R_N
#set_property -dict { PACKAGE_PIN J14 } [get_ports { vauxn3_0 }]; #IO_L20N_T3_AD6N_35 Sch=JA4_R_N
...
#set_property PACKAGE_PIN N16 [get_ports Vaux0_v_n]
#set_property PACKAGE_PIN N15 [get_ports Vaux0_v_p]
#set_property PACKAGE_PIN L15 [get_ports Vaux1_v_n]
#set_property PACKAGE_PIN L14 [get_ports Vaux1_v_p]
#set_property PACKAGE_PIN J16 [get_ports Vaux2_v_n]
#set_property PACKAGE_PIN K16 [get_ports Vaux2_v_p]
#set_property PACKAGE_PIN K14 [get_ports Vaux3_v_p]
#set_property PACKAGE_PIN J14 [get_ports Vaux3_v_n]
