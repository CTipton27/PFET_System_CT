...
(* CORE_GENERATION_INFO = "pfet_system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=pfet_system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=15,da_board_cnt=4,da_clkrst_cnt=2,da_ps7_cnt=4,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "pfet_system.hwdef" *) 
module pfet_system
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
